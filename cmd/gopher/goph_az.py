...
def main():
    ...
    gophModels = {                      # gopher model map
        'xxx.az':       [gophXXXAZ,     'fetch ... from Azure'],
    }
                                        # define and parse command line parameters
    parser = argparse.ArgumentParser(description='''This gopher agent fetches Cloud Monitor content for an Azure model''')
    parser.add_argument('model',        choices=gophModels, metavar='model',
                        help='''Azure model; {} are supported'''.format(', '.join(gophModels)))
