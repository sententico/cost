...
# Rackspace notes (pyrax deprecated/unsupported)
# https://docs.openstack.org/openstacksdk/latest/user/index.html
# https://pypi.org/project/rackspacesdk
...
def main():
    ...
    gophModels = {                      # gopher model map
        'xxx.rack':     [gophXXXRACK,   'fetch ... from Rackspace'],
    }
                                        # define and parse command line parameters
    parser = argparse.ArgumentParser(description='''This gopher agent fetches Cloud Monitor content for a Rackspace model''')
    parser.add_argument('model',        choices=gophModels, metavar='model',
                        help='''Rackspace model; {} are supported'''.format(', '.join(gophModels)))
